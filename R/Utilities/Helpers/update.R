...
#'
#' Quick helper to run 08_assign_figures.R and 09_render_figures.R
...
f <- function() {
  ...
  assign_script <- "R/Scripts/08_assign_figures.R"
  ...
  render_script <- "R/Scripts/09_render_figures.R"
